...
let port = process.env.REDIS_PORT || 6380;
let db = process.env.REDIS_DB || process.env.JEST_WORKER_ID || "0";
let password = process.env.REDIS_PASSWORD || 'RBOJ1cCNoGCKhlEBwQLHri1g+atWgn6Xn9HwNUbtzoVxAYxkiYBi7aufl8MILv1nxBqR7L6NNzI0X6cE';
